...
')
     ...
     */ 
        ...
        {
                        /** @var \Buzz\LaravelHCaptcha\Captcha $instance */
         ...
         * @static 
         */ 
        public static function getWidgetIdName()
        {
                        /** @var \Buzz\LaravelHCaptcha\Captcha $instance */
                        return $instance->getWidgetIdName();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getJsVariableName()
        {
                        /** @var \Buzz\LaravelHCaptcha\Captcha $instance */
                        return $instance->getJsVariableName();
        }
